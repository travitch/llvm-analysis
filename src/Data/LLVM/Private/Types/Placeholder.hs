module Data.LLVM.Private.Types.Placeholder (
  -- * Types
  Instruction(..),
  InstructionT(..),
  Constant(..),
...
data InstructionT = RetInst !(Maybe Constant)
            ...
            | UnwindInst
            | UnreachableInst
            | AddInst [ArithFlags] !Constant !Constant
            | SubInst [ArithFlags] !Constant !Constant
            | MulInst [ArithFlags] !Constant !Constant
            ...
            | ICmpInst !CmpPredicate !Constant !Constant
            | FCmpInst !CmpPredicate !Constant !Constant
...
data GlobalDeclaration = GlobalDeclaration !Identifier !Int !LinkageType !VisibilityStyle !GlobalAnnotation !Type !(Maybe Constant) !Integer !(Maybe ByteString)
